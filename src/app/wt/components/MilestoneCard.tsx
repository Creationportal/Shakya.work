...
export function MilestoneCard({
  ...
  if (!current) {
    return (
      <div className="rounded-2xl border border-dashed border-line bg-card p-4 text-center text-[11px] text-faint">
        No milestones set yet — add goals to track your progress.
      </div>
    );
  }
